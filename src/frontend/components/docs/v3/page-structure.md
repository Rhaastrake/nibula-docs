...
| **CSS** | The global stylesheet and the one of the current page, plus any CDN links you listed for it |
...
The global stylesheet is loaded before the page one, so your page rules always win.
